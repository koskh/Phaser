...
export function tileToPosition(positionInTile: IPositionInCell): IPositionInPixel {
...
export function positionToTile(positionInPixel: IPositionInPixel): IPositionInCell {
